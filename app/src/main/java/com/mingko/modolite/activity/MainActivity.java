package com.mingko.modolite.activity;
...
import com.mingko.modolite.fragment.ModoFragment;
import com.mingko.modolite.fragment.SettingConnectFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFragment() {
        ...
        modoFragment = new ModoFragment();
        settingConnectFragment = new SettingConnectFragment();
        currentFragment = FragmentState.MODO_FRAGMENT;
        //初始化为modoFragment
        fragmentManager.beginTransaction()
                .add(R.id.id_fragment_container, modoFragment)
    ...
    public void onBackPressed() {
        if (System.currentTimeMillis() < (exitTime + EXIT_TIME)) {
            modoFragment.endClientThread();
            super.onBackPressed();
        } else {
            if( currentFragment == FragmentState.MODO_FRAGMENT){
