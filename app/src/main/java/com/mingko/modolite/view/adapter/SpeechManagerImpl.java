package com.mingko.modolite.view.adapter;
...
import com.mingko.modolite.util.FileUtil;
 ...
 */
public class SpeechManagerImpl implements ISpeechManager {

    private Context mContext;

    //录音文件的保存路径
    private String mDir = FileUtil.MODO_TALK_PATH;
    ...
    private static SpeechManagerImpl mInstance;

    public static SpeechManagerImpl getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new SpeechManagerImpl(context);
        }
        return mInstance;
    }

    private SpeechManagerImpl(Context context) {
    ...
    private SpeechUnderstanderListener mSpeechUnderstanderListener = new SpeechUnderstanderListener() {
        ...
        public void onError(SpeechError error) {
            EventBus.getDefault().post(MsgBean.createModoTextAnswer("您说什么? 我没听清。"));
