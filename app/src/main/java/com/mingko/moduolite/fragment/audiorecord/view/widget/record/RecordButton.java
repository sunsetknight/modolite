package com.mingko.moduolite.fragment.audiorecord.view.widget.record;
...
import com.mingko.moduolite.fragment.audiorecord.model.event.AudioPreparedEvent;
import com.mingko.moduolite.fragment.audiorecord.model.event.VolumeChangEvent;
import com.mingko.moduolite.fragment.audiorecord.presenter.sound.SpeechManager;
                ...
                if (isWantCancel(x, y)) {
                    ...
                    if ((System.currentTimeMillis() - touchDownTime) < 500) {
                        ...
                        MsgBean msgBean = new MsgBean(MsgBean.FROM_USER, MsgBean.TYPE_AUDIO,
                                mSpeechManager.getCurrentFilePath(),
